...
public class OAuth2Authenticator {
  ...
  public static final class OAuth2Provider extends Provider {
    ...
    public OAuth2Provider() {
      ...
      put("SaslClientFactory.XOAUTH2",
          "com.ieprofile.helper.gmail.OAuth2SaslClientFactory");
    }
  }
   ...
   */
  public List<MessageBean> connectToImap(String host,
                                        int port,
                                        String userEmail,
                                        String oauthToken,
  ...
  public static void main(String args[]) throws Exception {
   ...
   // initialize();
    ...
    //SMTPTransport smtpTransport = connectToSmtp("smtp.gmail.com",465, email, oauthToken,  true);
