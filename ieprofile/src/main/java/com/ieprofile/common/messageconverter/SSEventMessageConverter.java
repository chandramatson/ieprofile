...
public class SSEventMessageConverter implements HttpMessageConverter<Object> {
	...
	public boolean canWrite(Class<?> clazz, MediaType mediaType) {
		boolean s = (String.class.equals(clazz) || SSEvent.class.equals(clazz))
				&& mediaType.includes(EVENT_STREAM_MEDIATYPE);
	...
	public void write(Object t, MediaType contentType, HttpOutputMessage outputMessage)
		...
		if (t instanceof SSEvent) {
			...
			if (event.getData() != null) {
				...
				sb.append("data:").append(mapper.writeValueAsString(event.getData())).append("\n");
			}
